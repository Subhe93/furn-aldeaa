      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            inputField(Applocalizations.of(context).translate("Add Card"),
                Applocalizations.of(context).translate("Enter Name here")),
            SizedBox(height: 10),
            customInput(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(
                Applocalizations.of(context).translate("Select Payment Method"),
                style: TextStyle(
                    color: Colors.black,
                    fontSize: 18,
                    fontWeight: FontWeight.bold),
          ...
          paymetMethodRow(Icons.attach_money,
              Applocalizations.of(context).translate("Cash on delivery"), 0),
          Padding(
          ...
          paymetMethodRow(Icons.credit_card,
              Applocalizations.of(context).translate("Add Credit Card"), 1),
          Padding(
            padding: const EdgeInsets.only(left: 15.0, right: 15),
            child: Divider(
              height: 5,
          ...
          paymetMethodRow(FontAwesomeIcons.applePay,
              Applocalizations.of(context).translate("Setup Apple Pay"), 2)
        ],
      ),
    );
  }
